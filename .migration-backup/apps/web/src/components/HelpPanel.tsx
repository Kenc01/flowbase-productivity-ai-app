...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    a: "Click the Bell icon in the sidebar footer. Grind OS generates smart alerts from your real data — overdue tasks, events today, high-priority tasks, and pinned notes.",
  },
  {
  ...
  return (
    ...
    >
        ...
        {(tab === "overview" && !search) && (
          <div>
            ...
            <div style={{
              ...
              <a
                href="mailto:support@grind-os.app"
                style={{
              ...
              >
                <ExternalLink size={11} /> support@grind-os.app
              </a>
            </div>
          </div>
        )}
      ...
      <div style={{
        ...
        <span style={{ fontSize: "0.64rem", color: "hsl(221, 14%, 38%)" }}>Grind OS v0.1.0 BETA</span>
