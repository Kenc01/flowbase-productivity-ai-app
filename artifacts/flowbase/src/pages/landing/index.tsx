    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px", height: 68, display: "flex", alignItems: "center", gap: 32 }}>
        ...
        <a href="#" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          ...
          <span style={{ fontFamily: "'Outfit',sans-serif", fontSize: "1.15rem", fontWeight: 800, color: "#fff", letterSpacing: "-0.02em" }}>FlowBase</span>
        </a>
  ...
  return (
    <section style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", padding: "100px 24px 80px", background: `linear-gradient(160deg, hsl(246 80% 7%) 0%, hsl(246 60% 11%) 50%, hsl(195 70% 9%) 100%)` }}>
      ...
      <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: "rgba(255,255,255,0.62)", textAlign: "center", maxWidth: 620, lineHeight: 1.7, margin: "0 0 38px" }}>
        FlowBase unifies your Kanban boards, notes, whiteboards, calendar, and AI assistant into one beautifully designed workspace. Stop switching apps. Start building.
      </p>
      ...
      <div style={{ width: "100%", maxWidth: 900, borderRadius: 18, overflow: "hidden", border: "1px solid rgba(116,103,240,0.28)", boxShadow: "0 30px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.04)", position: "relative" }}>
        <div style={{ background: "rgba(116,103,240,0.12)", backdropFilter: "blur(20px)", padding: "10px 16px", display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid rgba(116,103,240,0.2)" }}>
          ...
          <div style={{ flex: 1, height: 18, borderRadius: 4, background: "rgba(255,255,255,0.06)", maxWidth: 300, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ fontSize: "0.65rem", color: "rgba(255,255,255,0.3)" }}>flowbase.app/dashboard</span>
          </div>
        </div>
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "0.95rem", color: "#6b7280", lineHeight: 1.7, margin: "0 0 28px" }}>
            FlowBase AI (powered by Groq's Llama 3.3) understands your workspace context and takes real actions — it doesn't just answer questions, it works for you.
          </p>
        ...
        <div style={{ borderRadius: 18, overflow: "hidden", border: "1px solid rgba(116,103,240,0.2)", boxShadow: "0 24px 60px rgba(116,103,240,0.18)", background: "linear-gradient(160deg, hsl(246 80% 9%) 0%, hsl(246 60% 13%) 100%)" }}>
          <div style={{ padding: "14px 16px", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: "0.8rem", fontWeight: 700, color: "#fff" }}>FlowBase AI</div>
      ...
      <div style={{ maxWidth: 1060, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.55)", lineHeight: 1.7, margin: "0 0 28px" }}>
            Powered by Liveblocks, FlowBase delivers live presence, instant updates, and collaborative editing without any additional setup.
          </p>
    ...
    <section style={{ padding: "100px 24px", background: "#fff" }}>
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <p style={{ fontSize: "1rem", color: "#6b7280", maxWidth: 480, margin: "0 auto", lineHeight: 1.65 }}>From solo founders to large teams — FlowBase adapts to your workflow.</p>
        </div>
...
function Testimonials() {
  const items = [
    { name: "Sarah Chen", role: "Founder, Luminary Labs", avatar: "SC", color: "#7467F0", stars: 5, text: "FlowBase replaced four separate tools for my team. The AI assistant alone saves us two hours every day — it genuinely understands what we need and takes action." },
    { name: "Marcus Rivera", role: "Product Manager, Axiom", avatar: "MR", color: "#10B981", stars: 5, text: "The real-time collaboration on Kanban is flawless. We run daily standups using FlowBase and everyone stays perfectly in sync. The live presence feature is addictive." },
    { name: "Priya Nair", role: "PhD Student, MIT", avatar: "PN", color: "#F43F5E", stars: 5, text: "As a student managing research, coursework, and projects, FlowBase is a lifesaver. The AI summarizes my notes before exams and I've never felt more organized." },
  ];
  return (
    <section style={{ padding: "100px 24px", background: "#fff" }}>
...
function FAQ() {
  ...
  const items = [
    { q: "How does the AI Assistant work?", a: "FlowBase AI is powered by Groq's Llama 3.3 model. It has tools that let it take real actions in your workspace — creating tasks, adding calendar events, writing notes, and reading your live data to answer questions about your schedule and tasks." },
    ...
    <section style={{ padding: "100px 24px", background: "linear-gradient(160deg, hsl(246 80% 7%) 0%, hsl(246 60% 11%) 50%, hsl(195 70% 9%) 100%)", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center", position: "relative" }}>
        ...
        <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.55)", margin: "0 0 36px", lineHeight: 1.65 }}>
          Join thousands of founders, students, and teams who've made FlowBase their everything workspace. Free to start, no credit card needed.
        </p>
    ...
    <footer style={{ background: "hsl(246 80% 5%)", borderTop: "1px solid rgba(116,103,240,0.15)", padding: "56px 24px 36px" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 48 }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 14 }}>
              ...
              <span style={{ fontFamily: "'Outfit',sans-serif", fontSize: "1.1rem", fontWeight: 800, color: "#fff" }}>FlowBase</span>
            </div>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <span style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.3)" }}>© 2026 FlowBase. All rights reserved.</span>
