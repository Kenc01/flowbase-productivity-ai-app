  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      <Card>
        ...
        <SettingRow label="In-App Notifications" description="Show alerts inside FlowBase">
      ...
      <Card>
        ...
        <SettingRow label="Export My Data" description="Download a copy of all your FlowBase data" last>
          <button style={{
            display: "inline-flex", alignItems: "center", gap: "5px",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <Card>
        ...
        <SettingRow label="Account ID" description="Your unique FlowBase user ID">
          <span style={{
        ...
        <SettingRow label="Sign-In Methods" description="How you sign in to FlowBase" last>
      ...
      <Card>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: "0.74rem", color: "var(--fb-text-muted)" }}>Basic access to all FlowBase features</div>
          </div>
