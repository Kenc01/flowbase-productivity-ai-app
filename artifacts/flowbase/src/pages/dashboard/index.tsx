...
export default function DashboardPage() {
  ...
  if (data?.chatCount && data.chatCount > 0) {
    insights.push({ text: `You've asked FlowBase AI ${data.chatCount} question${data.chatCount !== 1 ? "s" : ""} — keep exploring!`, color: "#7467F0", Icon: Bot });
  }
      ...
      <div style={{ display: "flex", flexDirection: "column", minHeight: "100%" }}>
        ...
        <main style={{ flex: 1, padding: "24px 28px 40px", display: "flex", flexDirection: "column", gap: 20, overflowY: "auto" }}>
          ...
          <div onClick={() => navigate("/dashboard/ai-assistant")} style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: "0.95rem", fontWeight: 700, color: "#f0f0f8", marginBottom: 3 }}>FlowBase AI is ready</div>
